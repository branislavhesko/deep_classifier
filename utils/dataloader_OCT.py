...
def get_dataloaders_and_sizes(image_size, folders):
    ...
    tranform = {
        folders[0]: tfs.Compose([
            tfs.RandomResizedCrop(image_size[0]),
    ...
    dataloaders = {x: DataLoader(image_folders[x], batch_size=4, shuffle=True, num_workers=4) for x in folders}
